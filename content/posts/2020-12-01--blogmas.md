...
- [🎨 **12/12**: Back to top button (part 1)](#-1212-back-to-top-button-part-1)
...
## 🎨 **12/12**: Back to top button (part 1)
...
Having the back to top button hide everytime a scroll is detected was a bit too distracting. Instead, I want it to be hidden if the user is scrolling down, but visible if the user scrolls up. I also want the home button to slide down from the top the same time the back to top button is visible.
