...
- [⚙️ **12/13**: Use reading time plugin](#️-1213-use-reading-time-plugin)
...
## ⚙️ **12/13**: Use reading time plugin
...
Today's just gonna be quick and easy. Before, I calculated time read by literally copy and pasting a post into a Medium post draft and stealing their minutes. I had a `minutes` field in the frontmatter of every post and would query it. Instead of this jank approach, I using the `gatsby-remark-reading-time` [plugin](https://www.gatsbyjs.com/plugins/gatsby-remark-reading-time-v2/).
...
Let's see the posts where there's a difference between Medium and this plugin:
