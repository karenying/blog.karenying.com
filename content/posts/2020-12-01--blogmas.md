...
I remember reading this [article](https://medium.com/throughdesign/spotify-2019-wrapped-a-design-masterstroke-1d06b27b0aec) about Spotify Wrapped 2019's UI/UX design so here's my take on this year's!
...
You would think that this combo of colors from all across the spectrum would clash. However IMO, the gradient really ties the contrasting colors together. You end up with a sort of tropical + beachy + summery vibe (something we'd all appreciate right now...).
