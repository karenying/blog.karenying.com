...
Major apps like Facebook, Instagram, and Twitter switched to round propics around 2016 / 2017 and the reasoning is quite simple -- since heads are roundish, a circular image draws the eye more the center of a face than a square one. Round pics also cut off the unnecessary busy borders which helps highlight faces.

We see very few sharp corners in real life, so it makes sense that roundness is currently popular in UI/UX design (try to spot a corner on this site). Personally, sharp corners make me a bit uncomfy. I think round corners are so much friendlier!
