...
Having the back to top button hide everytime a scroll is detected was a bit too distracting. Instead, I want it to be hidden if the user is scrolling down, but visible if the user scrolls up. I also want the home button to appear at the top at the same time.
