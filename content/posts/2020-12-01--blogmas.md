...
Initially, I was lazy and kept the time as is, only changing the date. Then I decided I wanted the date AND time to accurately reflect when I posted. I would Google "UTC time now" and fill in the details manually -- for some reason I thought this was more efficient than figuring out one time how to account for timezone in ISO 8601.
