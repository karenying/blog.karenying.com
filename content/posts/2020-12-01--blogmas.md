...
I looked into [VSCode Snippets](https://code.visualstudio.com/docs/editor/userdefinedsnippets) today and made my own to help speed up React developement in particular.
