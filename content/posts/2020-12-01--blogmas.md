...
- [🎨 **12/19**: karenying.com projects tab redesign](#-1219-karenyingcom-projects-tab-redesign)
...
## 🎨 **12/19**: karenying.com projects tab redesign

I've been dying to get rid of the carousel forever. It looks bad on mobile because the arrows take up precious width space. It's also just hard to click on things that are close to the edge of the page. Instead, each project card will appear vertically stacked so that the user can scroll through them instead. On tablet, it'll be the mobile cards in a grid.

Introducing my proposed projects tab designs with some notes (peep the Figma [file](https://www.figma.com/file/y6LPfrHI1yzewrcdLBFVo6/karenying.com-redesign?node-id=0%3A1)):
...
This design change will bring the styling of karenying.com closer to that of this blog's. I was also definitely influenced by the Blogmas calendar [visualizer](https://www.blogmas.karenying.com/). Each card will still have one of the four accent colors but it'll be more subtle.

Tomorrow's minipost will be about implementing this change! I'm hoping to move away from using Material UI for this page and I'll be adding some projects that I've worked on in the last couple of months.
