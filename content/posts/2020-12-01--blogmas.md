...
I dabbled with having CSS in react files with [Material-UI](https://material-ui.com/styles/basics/). I have the same mixed feels with that as I do with styled-components.
...
Another thing I noticed was that when I inspect element on a styled-components element, the class names aren't semantic. For example I saw `class="sc-bdfBwQ bGgqpE"`. Often times I use class names to locate elements in a code base. Not sure what I would do in this case.

Anyways, while styled-components is something I'm definitely not used to, it has made me want to keep an open mind!
