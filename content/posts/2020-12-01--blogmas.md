...
- [🎊 **12/25**: Blogmas recap](#-1225-blogmas-recap)
...
2020 was definitely a big coding year for me! I switched my major to CS at the end of 2019, so this year has been me diving into the world of web dev. I worked on some full stack stuff and realized I definitely have a pref for frontend and an interest in product / design.
...
Wow we made it and Merry Christmas!
...
As promised, I stacked my GitHub contributions graph and almost maxed out my 300 free monthly Netlify build minutes LOL.
...
The fact that a HN front page post stemmed from a Blogmas post is wild. It only goes to show that if you throw enough ideas out there, something eventually sticks. That was one of two main my goals with Blogmas -- to get better at blogging, writing, and conveying thoughts. The other was to learn, create, and have fun~
...
No promises for Blogmas 2021. We'll see what the next year has in store for me and this blog 😛
