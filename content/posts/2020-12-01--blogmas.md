...
_Written while listening to my [Your Top Songs 2020 playlist](https://open.spotify.com/playlist/37i9dQZF1EMaba5daAs6pY?si=wFKQvUuVT7m7rKz6UlG0BQ)_
...
![wrapped palette](/media/blogmas/wrapped-palette.png)_Spotify Wrapped 2020 palette_
...
With these 4 colors, Spotify only uses 2 pairings throughout the story -- dark blue with green, and pink with cyan. These pairings have relatively high contrast ratios which makes text legible. Here's an example of dark pink on cyan:

![wrapped cover](/media/blogmas/wrapped-cover.PNG#width=300px)

In addition to this fixed color palette, Spotify also uses a rainbow-ish gradient as a common theme. The gradient features the dark blue, cyan, and green from above, as well as a black and warmer sunset-like hues. It appears primarily as a background, with the other 4 colors in the foreground.

You would think that this combo of colors -- especially ones from all across the color spectrum would clash. However, I think the gradient really ties the contrasting colors together. You get a sort of tropical, beachy, summery vibe instead.

These bright colors, along with its encouraging, uplifting comments such as:

> Even in 2020, you still found ways to grow

> You're a pioneer

really make you reflect on your year in music with a positive mindset. And that's their goal right -- to make you like this recap so much that you share it with friends and on social media. Even its stock [soared](https://www.investors.com/news/technology/spotify-stock-jumps-wrapped-report-joe-rogan-exclusivity/) because of the Wrapped hype.

Clearly Spotify has found a marketing strat that works. Afterall, I look forward to my Wrapped every year!

In case you were curious, here's mine:
