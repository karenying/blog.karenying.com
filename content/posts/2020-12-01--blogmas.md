...
In a nutshell, Spotify Wrapped is the most simple form of data viz. It shows that the app can do +=1, yay! However, people eat it up because of its nice UI/UX along with the FOMO it generates from seeing everyone post about it on social media.
