...
You would think that this combo of colors from all across the spectrum would clash. However, IMO the gradient really ties the contrasting colors together. You get a sort of tropical, beachy, summery vibe instead (something we'd all appreciate right now).

These bright colors, along with encouraging and uplifting comments such as:
